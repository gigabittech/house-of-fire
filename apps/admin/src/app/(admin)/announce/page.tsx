    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontFamily: 'Inter, system-ui', fontWeight: 500, fontSize: 13, color: 'var(--hof-text)' }}>
            {title}
          </span>
          {recommended && <Pill tone="amber" size="sm">Default</Pill>}
        </div>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              color: 'var(--hof-text)', outline: 'none', letterSpacing: '-0.01em',
            }}
          />
            ...
            {!photoAttached ? (
              <button
                ...
                style={{
                  ...
                  border: '1px dashed var(--hof-border)', borderRadius: 8,
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                  fontFamily: 'Inter, system-ui', fontSize: 13, color: 'var(--hof-text-sec)',
                  cursor: 'pointer',
                }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <rect stroke="currentColor" strokeWidth="1.5" x="3" y="4" width="18" height="16" rx="2" />
              ...
              <div style={{
                ...
                background: 'var(--hof-elevated)', height: 160,
                ...
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path stroke="var(--hof-text)" strokeWidth="2" strokeLinecap="round" d="M6 6 L18 18 M18 6 L6 18" />
                  </svg>
                </button>
              </div>
            )}
          ...
          {/* Submit row */}
          <div style={{
            marginTop: 18, paddingTop: 16, borderTop: '1px solid var(--hof-border)',
            ...
            <div style={{ fontFamily: 'Inter, system-ui', fontSize: 11, color: 'var(--hof-text-sec)' }}>
              ...
              {status === 'idle' && (
                <span>Posting to <span style={{ color: 'var(--hof-text)', fontWeight: 500 }}>Home Feed</span></span>
              )}
              {status === 'sending' && (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {HISTORY.map((item) => (
              <div key={item.id} style={{
                padding: 14, background: 'var(--hof-bg)',
                border: '1px solid var(--hof-border)', borderRadius: 10,
              }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                  <Pill tone={item.tone} size="sm">{item.kind}</Pill>
                  <span style={{ fontFamily: 'Inter, system-ui', fontSize: 11, color: 'var(--hof-text-sec)' }}>
                    {item.meta}
                  </span>
                </div>
                <div style={{
                  fontFamily: 'Clash Display, system-ui', fontWeight: 600, fontSize: 15,
                ...
                <div style={{
                  fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: 'var(--hof-text-sec)',
