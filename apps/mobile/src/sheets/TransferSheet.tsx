    ...
    >
      {stage === 'form' && (
        <>
          ...
          >
            They'll get the new ticket here. We'll verify their phone at the door.
          </div>
          ...
          <div
            style={{
              ...
              border: `1px solid rgba(232,162,26,0.3)`,
              borderRadius: 10,
              display: 'flex',
          ...
          >
            ...
            <div style={{ fontFamily: 'Inter', fontSize: 12, color: colors.text, lineHeight: 1.5 }}>
              One transfer per ticket. Once they accept, you can't un-transfer. Cutoff is 24h before
              doors.
            </div>
          </div>
      ...
      {stage === 'sent' && (
        <>
          <div style={{ textAlign: 'center', padding: '20px 0 8px' }}>
            ...
            >
              {name} has 24 hours to accept. We'll text you when they do — and your ticket
              disappears from this app.
            </div>
          </div>
          <div style={{ marginTop: 20 }}>
            <PrimaryBtn
