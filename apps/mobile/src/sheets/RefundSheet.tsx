...
export default function RefundSheet({ open, onClose, ticketId }: RefundSheetProps) {
  ...
  useEffect(() => {
    if (!open) { setStage('form'); setReason(''); setDetail(''); }
  }, [open]);
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: 'Inter', fontSize: 12, color: colors.textSec, lineHeight: 1.5 }}>
              Faster path:{' '}
              <span style={{ color: colors.amber }}>transfer your ticket</span>
              {' '}to a friend. They get to come, you get your money — no waiting on us.
            </div>
          </div>

          <div style={{ marginTop: 18 }}>
            <PrimaryBtn disabled={!reason} onClick={() => {
        ...
        <>
          <div style={{ textAlign: 'center', padding: '20px 0 8px' }}>
            <div style={{
              ...
              background: colors.elevated, border: `2px solid ${colors.amber}`,
