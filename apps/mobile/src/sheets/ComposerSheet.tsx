...
export default function ComposerSheet({ open, onClose, defaultChannel = 'general', onPost }: ComposerSheetProps) {
  ...
  useEffect(() => { if (open) setChannel(defaultChannel); }, [open, defaultChannel]);
      ...
      <div style={sheet}>
        ...
        <div style={{
          ...
          <button className="hof-btn" onClick={onClose} style={{
            fontFamily: 'Inter', fontSize: 13, color: colors.textSec, fontWeight: 500,
          }}>Cancel</button>
        ...
        <div className="hof-scroll" style={{ flex: 1, overflowY: 'auto', padding: '14px 16px 24px' }}>
          ...
          <input
            ...
            style={{
              ...
              color: colors.text, outline: 'none', letterSpacing: '-0.01em',
            }}
          />
          ...
          <textarea
            ...
            style={{
              ...
              background: 'transparent', border: 0,
              fontFamily: 'Inter', fontSize: 15, color: colors.text,
              ...
              <div style={{ position: 'relative' }}>
                <div style={{
                  ...
                  {([0, 1, 2] as const).map((seed) => (
                    <div key={seed} style={{
                      background: colors.elevated, borderRadius: 4,
